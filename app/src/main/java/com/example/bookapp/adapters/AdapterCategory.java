...
import com.example.bookapp.BookListAdminActivity;
...
public class AdapterCategory extends RecyclerView.Adapter<AdapterCategory.HolderCategory> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull AdapterCategory.HolderCategory holder, int position) {
        ...
        //handle item click, goto bookListAdminActivity also pass book category and categoryId
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, BookListAdminActivity.class);
                intent.putExtra("categoryId", id);
                intent.putExtra("categoryTittle", category);
